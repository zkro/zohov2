...
class customView
{
    ...
    public function getrecords($module="Leads",$start_index=1,$end_index=100,$customView_id=3988260000000087501)
    {
        $customviewinstance = ZCRMRestClient::getCustomViewInstance( $module,$customView_id);
        $response = ZCRMRestClient::getCustomViewInstance($module,$custom_view_id )->getRecords("Lead_Source", "asc", $start_index,$end_index );// to get the records(parameter - ,field_api_name-to sortby,sort_order(asc or desc),starting index,ending inde
